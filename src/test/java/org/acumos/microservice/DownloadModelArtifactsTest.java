...
public class DownloadModelArtifactsTest {
	...
	public void getModelArtifactsTest() {
		...
		try {
			...
			List list = downloadModelArtfct.getModelArtifacts("solutionId", "revisionId", "userName", "password", "nexusUrl", "nexusUserName", "nexusPassword", "org/acumos/hello-world/2/hello-world-2.json");

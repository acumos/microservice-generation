...
// on cmnDataService created @Mock where it should work on cmdDataSvc created by mock(....)
			...
			List list = downloadModelArtfct.getModelArtifacts("solutionId", "revisionId", "userName", "password",
					"nexusUrl", "nexusUserName", "nexusPassword", "org/acumos/hello-world/2/hello-world-2.json");

...
public class DockerizeModel {
	 ...
	 */
	public String dockerizeFile(MetadataParser metadataParser, File localmodelFile, String solutionID, String deployment_env) throws AcumosServiceException {

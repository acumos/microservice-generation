...
public class H2ODockerPreparator {
	...
	public H2ODockerPreparator(MetadataParser metadataParser, String http_proxy, String h2oModelRunnerUrl) throws AcumosServiceException {
	...
	public void createDockerFile(File inDockerFile, File outDockerFile) throws AcumosServiceException {
		try {
			...
			dockerFileAsString = MessageFormat.format(dockerFileAsString,
					new Object[] { serverPort, h2oModelRunnerUrl, modelname + ".zip", http_proxy });
